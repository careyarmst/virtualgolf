...
path('gpupdate/<int:purchase_id>/', views.golf_purchases_update_view, name='golf_purchase_update'),
path('gpdelete/<int:purchase_id>/', views.golf_purchases_delete_view, name='golf_purchase_delete'),
]